...
import { removeProduct, clearSelectedProduct, setModificationState,
  changeSelectedProduct, loadListOfProduct } from "../../store/actions/products.action";
import { addNotification } from "../../store/actions/notifications.action";
import { ProductModificationStatus, IProduct , IProductList} from "../../store/models/product.interface";
...
const Products: React.FC = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="row">
        <TopCard title="Documents COUNT" text={`${numberItemsCount}`} icon="box" class="success" />
