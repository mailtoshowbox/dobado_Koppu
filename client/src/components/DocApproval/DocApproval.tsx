...
import { getDocRequestApprovalList, updateDocCat } from "../../services/index";
...
const Products: React.FC = () => {
  ...
  useEffect(() => {
    getDocRequestApprovalList(account.auth).then((items: IDocApprovalList) => {
      dispatch(loadListOfDocApproval(items));
    });
    dispatch(updateCurrentPath("Home", "Categories"));
  }, [path.area, dispatch]);

  function onApprovalSelect(product: IDocApproval): void {
